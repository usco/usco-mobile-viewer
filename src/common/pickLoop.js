...
export default function pickLoop (fullData) {
  function onMouseChange (buttons, x, y, mods) {
    ...
    // warning !!! issues with camera-unproject , itself used in other modules https://github.com/Jam3/camera-unproject/issues/1
    ...
    fullData.entities.forEach(function (entity) {
